...
from src.database.associative_table import prod_rev_assoc, user_prod_assoc, user_shop_list_assoc, shop_list_prod_assoc
...
class Shoplist(Base):
    ...
    products_cart: Mapped[List[Product]] = relationship(secondary=user_shop_list_assoc)
...
class User(Base):
    ...
    products_cart: Mapped[List[Product]] = relationship(secondary=user_prod_assoc)
